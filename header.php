    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 mt-3">
              <a href="admin/index.php"><button type="button" id="login" class="btn btn-light">Sign In</button>
              <a href="signup.php"><button type="button" id="login" class="btn btn-light">Sign Up</button></a>
            </div>
            <!-- /LOGO -->
        </div>
    </div>
